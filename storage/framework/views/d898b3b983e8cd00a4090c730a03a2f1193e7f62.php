...
<?php $__env->startSection('content'); ?>
    ...
    <div style="display:none">
        ...
        <?php if($parent_ticket): ?>
            <?php echo Former::hidden('parent_ticket_id')->value($parent_ticket->public_id); ?>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading">
            <h3 class="panel-title"><?php echo e(trans('texts.new_ticket')); ?></h3>
        </div>
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-md-3">
                    <?php echo e(trans('texts.priority')); ?>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <?php echo e(trans('texts.due_date')); ?>
            ...
            <div class="row" style="margin-top: 10px;">
                <div class="col-md-3">
                    <?php echo e(trans('texts.internal_ticket')); ?>

                </div>

                <div class="col-md-9">
                    <?php echo Former::checkbox('is_internal')
                                ->label('')
            ...
            <div class="row" data-bind="visible: isParentTicketVisible()">
                ...
                <div class="col-md-3">
                    <?php echo e(trans('texts.parent_ticket')); ?>

                </div>

                <div class="col-md-9">

                    <?php echo Former::select('parent_ticket_id')
                            ->label('')
                            ->addOption('', '')
    ...
    <div class="row">
        <center class="buttons">
            <?php echo Button::primary(trans('texts.create_ticket'))->large()->withAttributes(['onclick' => 'saveAction()']); ?>
    ...
    <script type="text/javascript">
        ...
        $( function() {
            ...
            window.model = new ViewModel(<?php echo json_encode($old); ?>);
            ...
            <!----- User Selector ----->
            var users = <?php echo $account->users; ?>;
            var userMap = {};
            ...
            var parent_tickets = <?php echo $parent_tickets; ?>;
            var ticketMap = {};
            ...
            for (var i=0; i<parent_tickets.length; i++) {
                ...
                var ticketName = '<?php echo e(trans('texts.ticket_number')); ?>' + '' + ticket.ticket_number;
