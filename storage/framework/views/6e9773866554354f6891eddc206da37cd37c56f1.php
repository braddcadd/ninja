  ...
  <div class="modal-dialog">
    <div class="modal-content">
              ...
              <div role="tabpanel">
                  <ul class="nav nav-tabs" role="tablist" style="border: none">
                      <li role="presentation" class="active">
                          <a href="#keyboard_shortcuts" aria-controls="keyboard_shortcuts" role="tab" data-toggle="tab"><?php echo e(trans('texts.keyboard_shortcuts')); ?></a>
                      </li>
                      <li role="presentation">
                          <a href="#voice_commands" aria-controls="voice_commands" role="tab" data-toggle="tab"><?php echo e(trans('texts.voice_commands')); ?></a>
                      </li>
                  </ul>
              </div>
              </br>
      ...
      <div class="modal-footer">
        ...
        <a class="btn btn-primary" href="<?php echo e(config('ninja.knowledge_base_url')); ?>" target="_blank"><?php echo e(trans('texts.knowledge_base')); ?></a>
        <a class="btn btn-primary" href="<?php echo e(Utils::getDocsUrl(request()->path())); ?>" target="_blank"><?php echo e(trans('texts.user_guide')); ?></a>
